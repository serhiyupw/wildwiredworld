<template>
    ...
    <div class='bg-[#ffaf62]'>
      ...
      <main class='pt-44 overflow-hidden w-screen'>
        <div
        ...
        >
          ...
          <div
          class="title-sec absolute z-[2]  text-xl  left-0 w-full text-center flex flex-col justify-center z-2"
  ...
  <section class="  relative z-[1000000]  overflow-scroll h-screen text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            ...
            <a href="https://kristinapulejkova.com/"><h3 class="text-xl font-semibold mt-2">Kristina Pulejkova</h3></a>
            <p class="text-gray-300">(Game Narrative, Map, Mosaic Monuments)</p>
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://melissaschwarz.com/"><h3 class="text-xl font-semibold mt-2">Melissa Schwarz</h3></a>
            <p class="text-gray-300"> (Game Environment, Portal)</p>
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://www.instagram.com/sundachun/"><h3 class="text-xl font-semibold mt-2">Chun Sun</h3></a>
            <p class="text-gray-300">(Game Characters: Arboricor - Heart, Sylvan - Spleen, Aerophyta - Lung, Renalith - Kidney, Chlora - Liver, Violetta, Max, Nalu, Two-headed Flower)</p>
         ...
         <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://shonee.space/"><h3 class="text-xl font-semibold mt-2">Bianca Shonee Arroyo-Kreimes</h3></a>
            <p class="text-gray-300">(Game Characters: Siphnonophore, Fernbell, Leeverd, Barrus, Cnidaria)</p>
            <p>is a Montreal-based Costa Rican-Canadian digital media artist. Growing up on the edge of a rainforest in Costa Rica nourishes her creative practice as her work strives to resurrect the meaning of nature’s place in her own life now as both an urbanite and multidisciplinary artist. Within the virtual worlds she creates, 3D embodiments of organisms
              ...
              appreciation of the endangered, non-human world that humanity often takes for granted as her
              portrayals seek to embody humankind’s seemingly objective and narrow misunderstanding of
              nature in this time of ecological crisis.
              </p>
          </div>
        </div>
         ...
         <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://www.instagram.com/eternal.enginee/"><h3 class="text-xl font-semibold mt-2">Eternal Engine</h3></a>
            <p class="text-gray-300"> (Game Development and Built)</p>
         ...
         <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://alessiaarcuri.com/"><h3 class="text-xl font-semibold mt-2">Alessia Arcuri</h3></a>
            <p class="text-gray-300">(Graphic Design)</p>
         ...
         <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <!-- <img
              ...
              class="w-full h-auto rounded-lg"
            /> -->
            <a href="https://www.neriankey.me/"><h3 class="text-xl font-semibold mt-2">Nerian Keywan</h3></a>
            <p class="text-gray-300">(Animation and Motion Design)</p>
