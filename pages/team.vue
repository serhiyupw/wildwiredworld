<template>
                        ...
                        <div class=" w-2/5 p-0">
                            <img
                                ...
                                /> 
                                    ...
                                    Langthrone Park <p class='text-base leading-[1.4rem] '> <br/> Wild Wired! Rewilding Encounters of Langthorne Park by HERVISIONS is commissioned in response to the Radical Landscapes exhibition at the William Morris Gallery. 
                                    </p>
                                    </div> -->
  ...
  <!-- Teams/Collaborators Section -->
                <section class="relative z-[1] flex h-screen justify-start teams-section flex-wrap content-center py-10 text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            ...
            />
            <h3 class="text-xl font-semibold mt-2">Collaborator 1</h3>
            <p class="text-gray-300">Role: Designer</p>
          </div>
        </div>
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <img
              ...
              class="w-full h-auto rounded-lg"
            />
            <h3 class="text-xl font-semibold mt-2">Collaborator 2</h3>
            <p class="text-gray-300">Role: Developer</p>
          </div>
        </div>
        ...
        <div class="col-span-1">
          <div class="collaborator-card p-4 border border-[#455baf] rounded-lg">
            <img
              ...
              class="w-full h-auto rounded-lg"
            />
            <h3 class="text-xl font-semibold mt-2">Collaborator 3</h3>
            <p class="text-gray-300">Role: Artist</p>
          </div>
        </div>
      </div>
    </div>
