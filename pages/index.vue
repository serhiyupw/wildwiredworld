<template>
  ...
  <div>
    <main>
      <div
        class="h-screen w-screen text-[#ea4657]  "
        ref="background"
      >
        ...
        >
          ...
          <div class=" font-light flex text-[#ff438b]">
            <div class="titleborderheader ">Long Thorn Valley</div>
      ...
      <image class="" :xlink:href="mapPath" width="100%" height="100%" />
        ...
        <div class="svg-container h-screen w-screen lg:p-20 md:p-20 sm:p-0 flex justify-center items-center">
          <svg
            class="cloud-animation pointer-events-none h-screen w-[60vw]  flex flex-row justify-center items-center"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1238.06 672.1"
          >
          
            <image
              class="cloud-animation lg:p-5 md:p-5 sm:p-0"
              href="map.png"
              width="100%"
              height="100%"
            />
...
export default {
  ...
  updateTitleWidth() {
    ...
    updateGradient(event) {
      ...
      const color1 = `rgb(143,${108 - y},246, 0.6)`;
      const color2 = `rgb(${143 - x}, ${108 - y}, 246,  0.3)`;
