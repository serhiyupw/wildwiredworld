<template>
  ...
  <div>
    <main class="h-screen w-screen text-[#ffffff] bg-[#f46a7d] overflow-hidden fixed ">
      <div
      ...
      >
        ...
        <!-- <img
          overflow-hidden
              ...
              <div class="z-[2] relative p-10 flex flex-col h-screen text-sm  text-center justify-center items-center mt-auto mb-auto">
    <div class="mobile-text w-3/5 p-0">
        <span class=" text-outline text-6xl font-bold text-stroke">You are invited to visit</span>
        <h1 class="text-6xl  font-bold text-yellow-400 text-stroke">Long Thorn Valley</h1>
        <p class="leading-2 font-semibold  pt-10">
    ...
    <div class=" mobile-text w-3/5 p-0 font-semibold  text-left border border-solid rounded-lg">
    ...
    <a href="#map" class="text-2xl text-yellow-400 cursor-pointer mt-5 border border-solid rounded-lg border-yellow-400">
       <p class='p-5'> Enter </p>
        ...
        <div id="map" class="svg-container  h-screen w-screen lg:p-20 md:p-20 sm:p-0 flex flex-col justify-center items-center">
