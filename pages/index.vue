<template>
  <!-- mt-5 -->
  <div class="h-screen w-screen text-zinc-900">
    <!-- <a href="../world1" class="p-10 text-gray-100 flex items-center justify-end relative z-3">
    <div class='uppercase text-xs '>About</div>
  </a> -->
    <div class=" lg:p-10 md:p-10 sm:p-0  flex items-center justify-end lg:justify-end md:justify-end sm:justify-evenly  relative ">
      <button
      class="overlay-button"
      @click="toggleOverlay"
    >
      <div class="uppercase text-xs font-semibold">About</div>
    </button>
    <div class="uppercase text-xs font-semibold">Socials<span class="p-3">/</span>Instagram</div>
    </div>
    

    <div v-if="showOverlay" class="overlay">
      <!-- Content for the overlay -->
      <div class="overlay-content text-xs">
    ...
    <div
      class="fixed bottom-45  md:bottom-[unset] md:top-0 left-0 w-full text-center flex flex-col justify-center z-2 lg:p-10 md:p-10 sm:p-0"
    >
      <div class="uppercase text-xs">Long Thorn Valley</div>
      <h2 class="text-xs italic">Radical Landscapes</h2>
    </div>

    <!-- <svg class="cloud-animation h-[85vh] w-screen p-40 flex items-center">
      <image class="" :xlink:href="mapPath" width="100%" height="100%" />
    </svg> -->
        <div class="svg-container h-[85vh] w-screen  flex items-center">
 <svg class="cloud-animation h-[85vh] w-screen lg:p-40 md:p-40 sm:p-0  flex items-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1238.06 672.1">
  <image class="cloud-animation" href="map.png" width="100%" height="100%" />
  <defs>
                      <style>
                          .cls-1,
                          .cls-2 {
...
.overlay {
  ...
  transition: backdrop-filter 1.3s ease; /* Add a smooth transition effect */
