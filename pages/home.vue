  ...
  <div>
    ...
    <a href="#map" class="text-2xl text-yellow-400 cursor-pointer mt-5 border border-solid rounded-lg border-yellow-400">
       <p class='p-5'> Enter </p>
        ...
        <svg  class="cloud-animation  md:h-screen md:w-[60vw] w-screen  flex flex-row justify-center items-center" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1145 724" width="1145" height="724">
